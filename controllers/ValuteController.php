...
class ValuteController extends Controller
{
    ...
    /**
     * Displays a single Valute model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Updates an existing Valute model.
    ...
    /**
     * Deletes an existing Valute model.
    ...
    /**
     * Finds the Valute model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Valute the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Valute::findOne($id)) !== null) {
            return $model;
        }
